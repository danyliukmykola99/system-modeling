...
public static PetriNet CreateNetTask(double a) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
	...
	public static PetriNet CreateNetMultiplication(int x, int y) throws ExceptionInvalidNetStructure, ExceptionInvalidTimeDelay {
		ArrayList<PetriP> d_P = new ArrayList<>();
		ArrayList<PetriT> d_T = new ArrayList<>();
		ArrayList<ArcIn> d_In = new ArrayList<>();
		ArrayList<ArcOut> d_Out = new ArrayList<>();

		d_P.add(new PetriP("Y", y));
		d_P.add(new PetriP("Result",0));
		d_P.add(new PetriP("Y_copy",0));
		d_P.add(new PetriP("Flag 1",0));
		d_P.add(new PetriP("Flag 2",1));
		d_P.add(new PetriP("X", x));
		d_T.add(new PetriT("T1",0.0));
		...
		PetriNet d_Net = new PetriNet("Multiplication.pns",d_P,d_T,d_In,d_Out);
